 ...
 * IEEE Transactions on Wireless Communications ([TWC](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7693))
 * IEEE Transactions on Mobile Computing ([TMC](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7755))
 * IEEE Transactions on Communications ([TCOM](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=26))
 * IEEE Transactions on Green Communications and Networking ([TGCN](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7511293))
 * IEEE Transactions on Network and Service Management ([TNSM](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=4275028))
 * IEEE Network ([NETWORK](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=65))
